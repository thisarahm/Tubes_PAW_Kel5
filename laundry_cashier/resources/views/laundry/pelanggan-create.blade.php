...
<div class="content">
    ...
    <div class="card">
        <form action="{{ route('pelanggan.store') }}" method="POST">
            ...
            <input type="text" name="kode" placeholder="PLG001" required>

            <label>Nama Pelanggan</label>
            <input type="text" name="nama" placeholder="Nama pelanggan" required>

            <label>No Telp</label>
            <input type="text" name="no_telp" placeholder="08xxxxxxxx" required>

            <label>Email</label>
            <input type="email" name="email" placeholder="email@gmail.com">

            <label>Alamat</label>
            <textarea name="alamat" rows="3" placeholder="Alamat pelanggan"></textarea>
